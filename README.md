...
- About us section with site description, links to partners, Facebook and privacy statement. FAQs section with accordion to save screen space (FAQs can be added/edited/removed in admin dashboard). Newsletter signup form (found in About tab > Newsletter list in andmin dashboard).
...
source autogenerated ERD: [medium.com](https://medium.com/@yathomasi1/1-using-django-extensions-to-visualize-the-database-diagram-in-django-application-c5fa7e710e16)
...
source interactive ERD: [mermaid.live](https://mermaid.live/edit#pako:eNqlVcFu2zAM_RVD57RYiiZpfRs2FBg6bBm6XYYABmsxKTFZciW6bZ[…]G4_HlcHI-UEsVnww_nF7KmlyMx-dj-RldrAfq2TkJMazcf1f78o71X3LsbXI)
